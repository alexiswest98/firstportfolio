        ...
        <div className="about-me-info">
            ...
            <div className="about-me-info-inner">
                ...
                <div className="bottom-about-div">
                    ...
                    <h4 className="bio-text">After graduating from San Francisco State University, I decided that I wanted to dive deeper into software engineering, which was something I was alwys passionate about ever since I was young and would modify the HTML on my old Tumblr blog. I decided to take Harvard CS50's course to get some more experience with different coding languages and learn more about DSA. I still remember the first lines of code I wrote and the silly Spongebob-themed game I made on Scratch which inspired me to learn how to create or develop whatever my mind imagined.</h4>
